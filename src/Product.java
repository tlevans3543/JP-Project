 ...
 * Date: 29-09-2018
 * Description: Type superclass extended by class AudioPlayer, creates and prints information of
 * type "Product".
 */
...
public class Product implements Item,Comparable<Product>{
   ...
   * name. You will also assign a serial number from the currentProductionNumber. The
